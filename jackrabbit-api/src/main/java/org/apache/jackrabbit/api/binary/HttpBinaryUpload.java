 ...
 *
 * <p>
 * If {@link #getUploadURLs()} includes only a single entry or if the actual file size is
 ...
 *     <li><code>partURLCount</code>: the number of entries in {@link #getUploadURLs()}</li>
 *     <li><code>partURLs</code>: the entries in {@link #getUploadURLs()}</li>
