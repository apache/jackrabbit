===============================
Welcome to Jackrabbit JCR Tests
===============================
...
Collective work: Copyright 2006-2008 The Apache Software Foundation.
...
package the jackrabbit-jcr-tests jar using the following command:
...
you can checkout the latest source using the following command:
    ...
    svn checkout http://svn.apache.org/repos/asf/jackrabbit/trunk/jackrabbit-jcr-tests
