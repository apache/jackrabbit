 ...
 * This class tries to calculates the best cache sizes by comparing the access counts of each cache,
 * and the used memory. The idea is, the more a cache is accessed, the more memory it should get,
 * while the cache should not shrink too quickly. A minimum and maximum size per cache is defined as well.
...
public class CacheManager implements Runnable {
    ...
    public static class CacheInfo {
        ...
        CacheInfo(Cache cache) {
            ...
            // the exact values are not important, but it is important that the values don't change
