...
public final class Operations {
  ...
  //--------------------------------------------------------< SetPolicy >---
    public static class SetTree implements Operation {
        ...
        @Override
        public String toString() {
            return "SetPolicy[" + parentId + ", " + aclTree+"]";
        }
        ...
        public boolean equals(SetTree other) {
            return Operations.equals(parentId, other.parentId)
                && Operations.equals(aclTree, other.aclTree);
        }
     ...
     * @return
     */
    public static Operation setTree(NodeId parentId, Tree aclTree) {
