...
To build Jackrabbit, you first need to download the jcr-2.0-b17.jar and
jcr-2.0-b17.xml files from https://issues.apache.org/jira/browse/JCR-1104
and install them to your local Maven repository:

    mvn install:install-file \
        -Dfile=jcr-2.0-b17.jar -DpomFile=jcr-2.0-b17.xml
