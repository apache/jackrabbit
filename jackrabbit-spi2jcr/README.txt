=================================
Welcome to Jackrabbit SPI2JCR
=================================

This is the SPI2JCR component of the Apache Jackrabbit project.
...
package the jackrabbit-spi-commons jar using the following command:
...
you can checkout the latest source using the following command:
    ...
    svn checkout http://svn.apache.org/repos/asf/jackrabbit/trunk/jackrabbit-spi2jcr
