...
public class AccessControlListImpl extends AbstractAccessControlList {
    ...
    //-------------------------------------------------< AccessControlList >---
    /**
     * TODO: do a fine-grain synchronization: if the removal does not interfere with adding an entry
     * then both operations should be allowed on the list at the same time.
     * 
     */
    @Override
