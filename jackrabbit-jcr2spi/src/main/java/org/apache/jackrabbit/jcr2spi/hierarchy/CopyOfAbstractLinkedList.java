...
/*
 * This is a copy of org.apache.commons.collections4.list.AbstractLinkedList
 * with dependencies inlined and two methods changed for JDK 21 conformance;
 * see https://issues.apache.org/jira/browse/COLLECTIONS-842 and https://issues.apache.org/jira/browse/JCR-4940
 */
 ...
 * @since 3.0
 */
abstract class CopyOfAbstractLinkedList<E> implements List<E> {
    ...
    public String toString() {
        ...
        buf.append(DEFAULT_TOSTRING_PREFIX);
        ...
        buf.append(DEFAULT_TOSTRING_SUFFIX);
        return buf.toString();
    }
     ...
     */
    protected static class LinkedListIterator<E> implements ListIterator<E>, CopyOfOrderedIterator<E> {

        /** The parent list */
        protected final CopyOfAbstractLinkedList<E> parent;

        /**
         * The node that will be returned by {@link #next()}. If this is equal
         * to {@link CopyOfAbstractLinkedList#header} then there are no more values to return.
         */
        protected Node<E> next;
         ...
         */
        protected LinkedListIterator(final CopyOfAbstractLinkedList<E> parent, final int fromIndex)
    ...
    /**
     * The sublist implementation for CopyOfAbstractLinkedList.
     *
     * @param <E> the type of elements in this list.
     */
    protected static class LinkedSubList<E> extends AbstractList<E> {
        /** The main list */
        CopyOfAbstractLinkedList<E> parent;
        ...
        protected LinkedSubList(final CopyOfAbstractLinkedList<E> parent, final int fromIndex, final int toIndex) {
            if (fromIndex < 0) {
    ...
    // inlined dependencies from commons-collections

    private interface CopyOfOrderedIterator<E> extends Iterator<E> {
