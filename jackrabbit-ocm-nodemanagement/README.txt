=========================================
Welcome to Jackrabbit OCM Node Management
=========================================
...
package the jackrabbit-ocm-nodemanagement jar using the following command:

    mvn package

See the Maven 2 documentation for other build features.

Note that you need Java 5 to build this component.
...
you can checkout the latest source using the following command:
    ...
    svn checkout http://svn.apache.org/repos/asf/jackrabbit/trunk/jackrabbit-ocm-nodemanagement
