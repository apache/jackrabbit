...
public class ExportDocViewTestData extends AbstractJCRTest {
    ...
    private void fillInValidNameProp(Node dataRoot) throws RepositoryException, IOException {
    ...
    private void fillInInvalidXMLNameProp(Node dataRoot) throws RepositoryException, IOException {
