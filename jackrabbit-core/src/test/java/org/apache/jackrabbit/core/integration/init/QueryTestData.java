...
public class QueryTestData extends AbstractJCRTest {
    ...
    /**
     * Creates four nodes under {@link #TEST_DATA_PATH}. Three nodes with
     * name {@link #nodeName1} and a fourth with name {@link #nodeName2}.
     * Each node has a String property named {@link #propertyName1} with some
     * content set.
     */
