 ...
 */
public class ConfException extends RepositoryException {

	private static final long serialVersionUID = -3142383451574534838L;
     ...
     */
    public ConfException(String message, Exception cause) {
        super(message, cause);
    }
