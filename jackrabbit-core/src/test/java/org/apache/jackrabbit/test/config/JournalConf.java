...
public class JournalConf extends BeanConf {

	public JournalConf(BeanConf beanConf) {
		super(beanConf);
	}

	public JournalConfig createJournalConfig(Variables variables) throws ConfException {
		return new JournalConfig(super.createBeanConfig(variables));
	}

	public void print(PrettyPrinter pp) {
		pp.printlnIndent("[Journal");
