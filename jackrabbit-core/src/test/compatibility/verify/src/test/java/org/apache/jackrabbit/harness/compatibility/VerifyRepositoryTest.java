...
public class VerifyRepositoryTest
    ...
    protected void verifyTestData(Session session) throws Exception {
        // additionally verify that jcr:activities is there
        assertTrue("jcr:activities missing",
                session.getRootNode().hasNode(JCR_SYSTEM + "/jcr:activities"));
        super.verifyTestData(session);
    }
}
